...
(1, 'Corolla', 'Sedan', 21000, 'Toyota', 2022, 'VIN0011223344556601', 2, 'Available'),
(2, 'Accord', 'Sedan', 30000, 'Honda', 2021, 'VIN0011223344556602', 3, 'Available'),
(3, 'Rogue', 'SUV', 28000, 'Nissan', 2022, 'VIN0011223344556603', 4, 'Unavailable'),
(4, 'Escape', 'SUV', 25000, 'Ford', 2023, 'VIN0011223344556604', 5, 'Available'),
(5, 'Model 3', 'Sedan', 15000, 'Tesla', 2023, 'VIN0011223344556605', 1, 'Available'),
(1, 'CX-5', 'SUV', 33000, 'Mazda', 2021, 'VIN0011223344556606', 3, 'Available'),
(2, 'Highlander', 'SUV', 24000, 'Toyota', 2022, 'VIN0011223344556607', 2, 'Unavailable'),
(3, 'Sentra', 'Compact', 19000, 'Nissan', 2023, 'VIN0011223344556608', 5, 'Available'),
(4, 'Pilot', 'SUV', 27000, 'Honda', 2020, 'VIN0011223344556609', 1, 'Available'),
(5, 'Fusion', 'Sedan', 32000, 'Ford', 2021, 'VIN0011223344556610', 4, 'Unavailable');
...
SELECT 
'507-200-' + RIGHT('00' + CAST(Customer_ID AS VARCHAR(2)), 2),
'507-300-' + RIGHT('00' + CAST(Customer_ID AS VARCHAR(2)), 2),
NULL,
Customer_ID,
CASE WHEN Customer_ID % 3 = 1 THEN 1 WHEN Customer_ID % 3 = 2 THEN 2 ELSE 3 END
FROM Customers;
...
DATEADD(DAY, Customer_ID+5, '2025-10-20'),
Customer_ID,
CASE WHEN Customer_ID % 3 = 1 THEN 1 WHEN Customer_ID % 3 = 2 THEN 2 ELSE 3 END,
